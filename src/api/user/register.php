    ...
    try{
        if ($_SERVER['REQUEST_METHOD'] === 'POST'){
            ...
            if(!$username){
                ...
                logError($conn,"Registration Failed: missing Username",__FILE__,__LINE__,null);
            ...
            if (!$email){
                ...
                logError($conn,"Registration Failed: missing Email",__FILE__,__LINE__,null);
            ...
            if(!$password){
                ...
                logError($conn,"Registration Failed: missing password",__FILE__,__LINE__,null);
            ...
            if(!filter_var($email, FILTER_VALIDATE_EMAIL)){
                ...
                logError($conn,"Registration Failed: invalid email",__FILE__,__LINE__,null);
            ...
            if(strlen($password) < 6){
                ...
                logError($conn,"Registration Failed: invalid password length",__FILE__,__LINE__,null);
            ...
            if($user->findByEmailOrUsername($email, $username)){
                ...
                logError($conn,"Registration Failed: already registered user",__FILE__,__LINE__,null);
            ...
            if($userData = $user->create($username, $email, $passwordHash)){
                ...
                logError($conn,"Registration Failed: could not create user record",__FILE__,__LINE__,null);
            ...
            logError($conn,"Registration route accessed with invalid method",__FILE__,__LINE__,null);
